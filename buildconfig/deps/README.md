...
`mac/build_mac_deps.sh` is designed to be run on a Virtual Machine that can be destroyed. It deletes some homebrew files, and messes with /usr/local/. It tries to work as far back as Mac OSX 10.11 for x64 and 11.0 for arm64.
