...
def place_downloaded_prebuilts(temp_dir, move_to_dir, x86=True, x64=True):
    ...
    prebuilt_x64 = os.path.join(
        temp_dir, "prebuilt-x64-pygame-2.1.4-20220319", "prebuilt-x64"
    )
    prebuilt_x86 = os.path.join(
        temp_dir, "prebuilt-x86-pygame-2.1.4-20220319", "prebuilt-x86"
    )
    ...
    for prebuilt_dir in prebuilt_dirs:
        ...
        copy(
            os.path.join(temp_dir, "SDL2_image-devel-2.8.0-VCpgce/SDL2_image-2.8.0"),
            os.path.join(move_to_dir, prebuilt_dir, "SDL2_image-2.8.0"),
        )
        copy(
            os.path.join(temp_dir, "SDL2_mixer-devel-2.6.2-VC/SDL2_mixer-2.6.2"),
            os.path.join(move_to_dir, prebuilt_dir, "SDL2_mixer-2.6.2"),
        )
        copy(
            os.path.join(temp_dir, "SDL2_ttf-devel-2.20.2-VC/SDL2_ttf-2.20.2"),
            os.path.join(move_to_dir, prebuilt_dir, "SDL2_ttf-2.20.2"),
        )
        copy(
            os.path.join(temp_dir, "SDL2-devel-2.28.5-VC/SDL2-2.28.5"),
            os.path.join(move_to_dir, prebuilt_dir, "SDL2-2.28.5"),
        )
