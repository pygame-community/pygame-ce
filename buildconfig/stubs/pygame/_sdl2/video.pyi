...
class Renderer:
    ...
    draw_blend_mode: int
    def clear(self, color: ColorValue = (0, 0, 0, 255)) -> None: ...
    ...
    def draw_line(self, p1: Iterable[float], p2: Iterable[float], color: ColorValue = (255, 255, 255, 255)) -> None: ...
    def draw_point(self, point: Iterable[float], color: ColorValue = (255, 255, 255, 255)) -> None: ...
    def draw_rect(self, rect: RectValue, color: ColorValue = (255, 255, 255, 255)) -> None: ...
    def fill_rect(self, rect: RectValue, color: ColorValue = (255, 255, 255, 255)) -> None: ...
    def draw_triangle(
        self, p1: Iterable[float], p2: Iterable[float], p3: Iterable[float], color: ColorValue = (255, 255, 255, 255)
    ) -> None: ...
    def fill_triangle(
        self, p1: Iterable[float], p2: Iterable[float], p3: Iterable[float], color: ColorValue = (255, 255, 255, 255)
    ) -> None: ...
    def draw_quad(
        self, p1: Iterable[float], p2: Iterable[float], p3: Iterable[float], p4: Iterable[float], color: ColorValue = (255, 255, 255, 255)
    ) -> None: ...
    def fill_quad(
        self, p1: Iterable[float], p2: Iterable[float], p3: Iterable[float], p4: Iterable[float], color: ColorValue = (255, 255, 255, 255)
    ) -> None: ...
