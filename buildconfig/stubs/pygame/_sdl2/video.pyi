...
class Window:
    ...
    def set_relative_mouse_mode(self, enabled: bool) -> None: ...
...
class Image:
    ...
    def set_origin(self, origin: Iterable[int]) -> None: ...
    def get_color(self) -> Color: ...
    def set_color(self, color: Color) -> None: ...
    texture: Texture
    srcrect: Rect
...
class Renderer:
    ...
    def set_draw_blend_mode(self, blend_mode: int) -> int: ...
    ...
    def set_target(self, target: Optional[Texture]) -> None: ...
    def blit(
        self,
