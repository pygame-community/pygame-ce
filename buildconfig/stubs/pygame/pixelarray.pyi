...
class PixelArray:
    ...
    @overload
    def __setitem__(self, index: int, value: PixelArray | int): ...
    @overload
    def __setitem__(self, index_range: slice, value: PixelArray): ...
    # only valid for a 2D PixelArray
    @overload
    def __setitem__(self, indices: tuple[int, int], value: int): ...
    # returns self
    @overload
    def __setitem__(self, ell: EllipsisType, value: PixelArray): ...
