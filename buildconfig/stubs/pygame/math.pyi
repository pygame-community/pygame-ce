...
class Vector2(_GenericVector):
    ...
    @deprecated("since 2.1.1. Use rotate_rad_ip instead")
...
class Vector3(_GenericVector):
    ...
    @deprecated("since 2.1.1. Use rotate_x_rad_ip instead")
    ...
    @deprecated("since 2.1.1. Use rotate_y_rad_ip instead")
    ...
    @deprecated("since 2.1.1. Use rotate_z_rad_ip instead")
