...
_Float_or_Vec = TypeVar("_Float_or_Vec", bound= (float | Vector2 | Vector3))
def lerp(a: _Float_or_Vec, b: _Float_or_Vec, weight: float, clamp: bool) -> _Float_or_Vec: ...
def smoothstep(a: _Float_or_Vec, b: _Float_or_Vec, weight: float) -> _Float_or_Vec: ...
