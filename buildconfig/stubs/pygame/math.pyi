...
class Vector2(_GenericVector):
    ...
    def rotate_ip_rad(self, angle: float, /) -> None:"""Deprecated since 2.1.1. Use rotate_rad_ip instead"""
...
class Vector3(_GenericVector):
    ...
    def rotate_ip_rad(
        self: _TVec, angle: float, axis: Union[Sequence[float], _TVec], /
    ) -> None:"""Deprecated since 2.1.1. Use rotate_rad_ip instead"""
    ...
    def rotate_x_ip_rad(self, angle: float, /) -> None:"""Deprecated since 2.1.1. Use rotate_x_rad_ip instead"""
    ...
    def rotate_y_ip_rad(self, angle: float, /) -> None:"""Deprecated since 2.1.1. Use rotate_y_rad_ip instead"""
    ...
    def rotate_z_ip_rad(self, angle: float, /) -> None:"""Deprecated since 2.1.1. Use rotate_z_rad_ip instead"""
...
def enable_swizzling() -> None:"""Deprecated"""
def disable_swizzling() -> None:"""Deprecated"""
