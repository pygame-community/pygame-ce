...
DIRECTION_TTB: int
DISPLAYADDED: int
DISPLAYCONTENTSCALECHANGED: int
DISPLAYCURRENTMODECHANGED: int
DISPLAYDESKTOPMODECHANGED: int
DISPLAYMOVED: int
DISPLAYORIENTATIONCHANGED: int
DISPLAYREMOVED: int
DISPLAYUSABLEBOUNDSCHANGED: int
DOUBLEBUF: int
DROPBEGIN: int
DROPCOMPLETE: int
DROPFILE: int
...
SYSTEM_THEME_DARK: int
SYSTEM_THEME_LIGHT: int
SYSTEM_THEME_UNKNOWN: int
SYSWMEVENT: int
TEXTEDITING: int
TEXTINPUT: int
