...
DIRECTION_TTB: int
DISPLAY_ADDED: int
DISPLAY_CONTENT_SCALE_CHANGED: int
DISPLAY_CURRENT_MODE_CHANGED: int
DISPLAY_DESKTOP_MODE_CHANGED: int
DISPLAY_MOVED: int
DISPLAY_ORIENTATION_CHANGED: int
DISPLAY_REMOVED: int
DISPLAY_USABLE_BOUNDS_CHANGED: int
DOUBLEBUF: int
DROPBEGIN: int
DROPCOMPLETE: int
DROPFILE: int
