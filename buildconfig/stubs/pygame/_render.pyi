...
class Renderer:
    ...
    def logical_to_window(self, point: Point) -> tuple[int, int]: ...
    def window_to_logical(self, point: Point) -> tuple[float, float]: ...
    def render_coordinates_to_window(self, point: Point) -> tuple[float, float]: ...
    def render_coordinates_from_window(self, point: Point) -> tuple[float, float]: ...
