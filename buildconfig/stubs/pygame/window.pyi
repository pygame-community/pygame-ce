...
from pygame.typing import CoordinateLike, RectLike
...
class Window:
    def __init__(
        ...
        size: CoordinateLike = (640, 480),
        position: Union[int, CoordinateLike] = WINDOWPOS_UNDEFINED,
        **flags: bool
    ) -> None: ...
    ...
    @minimum_size.setter
    def minimum_size(self, value: CoordinateLike) -> None: ...
    @property
    def maximum_size(self) -> Tuple[int, int]: ...
    @maximum_size.setter
    def maximum_size(self, value: CoordinateLike) -> None: ...
    @property
    def position(self) -> Tuple[int, int]: ...
    @position.setter
    def position(self, value: Union[int, CoordinateLike]) -> None: ...
    @property
