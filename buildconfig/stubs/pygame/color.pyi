import sys
from typing import Any, Dict, Iterator, Tuple, overload, Union
...
class Color(Collection[int]):
    ...
    def __getattr__(self, attr: str) -> Union[Color, tuple]: ...
    def __setattr__(self, attr: str, value: Union[Color, tuple]) -> int: ...
