...
_CanBeCircle = Union[Circle, Tuple[CoordinateLike, float], SequenceLike[float]]
...
_CanBeCollided = Union[Circle, Rect, FRect, CoordinateLike, Vector2]
...
class Circle:
    ...
    @overload
    def __init__(self, pos: CoordinateLike, r: float) -> None: ...
    @overload
    def __init__(self, circle: _CircleValue) -> None: ...
    @overload
    def move(self, x: float, y: float, /) -> Circle: ...
    @overload
    def move(self, move_by: CoordinateLike, /) -> Circle: ...
    @overload
    ...
    @overload
    def update(self, center: CoordinateLike, r: float, /) -> None: ...
    @overload
    def rotate(self, angle: float, rotation_point: CoordinateLike, /) -> Circle: ...
    @overload
    def rotate(self, angle: float, /) -> Circle: ...
    @overload
    def rotate_ip(self, angle: float, rotation_point: CoordinateLike, /) -> None: ...
    @overload
