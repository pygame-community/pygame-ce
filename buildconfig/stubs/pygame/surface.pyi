...
class Surface:
    ...
    def set_masks(self, color: ColorValue, /) -> None:"""Deprecated since 2.0.0. Immutable in SDL2"""
    def get_shifts(self) -> RGBAOutput: ...
    def set_shifts(self, color: ColorValue, /) -> None:"""Deprecated since 2.0.0. Immutable in SDL2"""
