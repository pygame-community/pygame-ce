...
class Surface:
    ...
    def blit(
        self,
        source: Surface,
        dest: Union[CoordinateLike, RectLike] = (0, 0),
    ...
    def blits(
        ...
        blit_SequenceLike: Iterable[
            Union[
                Tuple[Surface, Union[CoordinateLike, RectLike]],
                Tuple[Surface, Union[CoordinateLike, RectLike], Union[RectLike, int]],
                Tuple[Surface, Union[CoordinateLike, RectLike], RectLike, int],
            ]
        ],
    ...
    def fblits(
        self,
        blit_SequenceLike: Iterable[Tuple[Surface, Union[CoordinateLike, RectLike]]],
        special_flags: int = 0, /
    ) -> None: ...
    @overload
    ...
    def get_colorkey(self) -> Optional[RGBALike]: ...
    @overload
    ...
    def get_at(self, x_y: CoordinateLike, /) -> Color: ...
    def set_at(self, x_y: CoordinateLike, color: ColorLike, /) -> None: ...
    def get_at_mapped(self, x_y: CoordinateLike, /) -> int: ...
    ...
    @overload
    def subsurface(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> Surface: ...
    @overload
    def subsurface(
