...
class Surface:
    ...
    def get_at(self, x_y: Union[Tuple[float, float], Sequence[float], Vector2]) -> Color: ...
    def set_at(self, x_y: Union[Tuple[float, float], Sequence[float], Vector2], color: ColorValue) -> None: ...
