...
from pygame.typing import CoordinateLike, SequenceLike, IntCoordinateLike
...
@overload
def set_pos(pos: CoordinateLike, /) -> None: ...
@overload
...
@overload
def set_cursor(hotspot: IntCoordinateLike, surface: Surface) -> None: ...
