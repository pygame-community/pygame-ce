...
from pygame.typing import CoordinateLike, RectLike, SequenceLike
...
class _GenericRect(Collection[_N]):
    ...
    @midtop.setter
    def midtop(self, value: CoordinateLike) -> None: ...
    @property
    def midleft(self) -> Tuple[_N, _N]: ...
    @midleft.setter
    def midleft(self, value: CoordinateLike) -> None: ...
    @property
    def midbottom(self) -> Tuple[_N, _N]: ...
    @midbottom.setter
    def midbottom(self, value: CoordinateLike) -> None: ...
    @property
    def midright(self) -> Tuple[_N, _N]: ...
    @midright.setter
    def midright(self, value: CoordinateLike) -> None: ...
    @property
    ...
    @overload
    def __init__(self, left_top: CoordinateLike, width_height: CoordinateLike) -> None: ...
    @overload
    ...
    @overload
    def move(self, move_by: CoordinateLike, /) -> Self: ...
    @overload
    def move_ip(self, x: float, y: float, /) -> None: ...
    @overload
    def move_ip(self, move_by: CoordinateLike, /) -> None: ...
    def move_to(self, **kwargs: Union[float, CoordinateLike]) -> Self: ...
    @overload
    def inflate(self, x: float, y: float, /) -> Self: ...
    @overload
    def inflate(self, inflate_by: CoordinateLike, /) -> Self: ...
    @overload
    def inflate_ip(self, x: float, y: float, /) -> None: ...
    @overload
    def inflate_ip(self, inflate_by: CoordinateLike, /) -> None: ...
    @overload
    def scale_by(self, x: float, y: float = ...) -> Self: ...
    @overload
    def scale_by(self, scale_by: CoordinateLike) -> Self: ...
    @overload
    def scale_by_ip(self, x: float, y: float = ...) -> None: ...
    @overload
    def scale_by_ip(self, scale_by: CoordinateLike) -> None: ...
    @overload
    def update(self, left: float, top: float, width: float, height: float, /) -> None: ...
    @overload
    def update(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> None: ...
    @overload
    def update(self, single_arg: RectLike, /) -> None: ...
    @overload
    def clamp(self, rect: RectLike, /) -> Self: ...
    @overload
    def clamp(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> Self: ...
    @overload
    def clamp(self, left: float, top: float, width: float, height: float, /) -> Self: ...
    @overload
    def clamp_ip(self, rect: RectLike, /) -> None: ...
    @overload
    def clamp_ip(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> None: ...
    @overload
    def clamp_ip(
        self, left: float, top: float, width: float, height: float, /
    ) -> None: ...
    ...
    @overload
    def clip(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> Self: ...
    @overload
    ...
    @overload
    def clipline(
        self, first_coordinate: CoordinateLike, second_coordinate: CoordinateLike, /
    ) -> Union[Tuple[Tuple[_N, _N], Tuple[_N, _N]], Tuple[()]]: ...
    @overload
    def clipline(
    ...
    @overload
    def union(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> Self: ...
    @overload
    def union(self, left: float, top: float, width: float, height: float, /) -> Self: ...
    @overload
    def union_ip(self, rect: RectLike, /) -> None: ...
    @overload
    def union_ip(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> None: ...
    @overload
    def union_ip(
        self, left: float, top: float, width: float, height: float, /
    ) -> None: ...
    ...
    @overload
    def fit(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> Self: ...
    @overload
    ...
    @overload
    def contains(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> bool: ...
    @overload
    def contains(
        self, left: float, top: float, width: float, height: float, /
    ) -> bool: ...
    ...
    @overload
    def collidepoint(self, x_y: CoordinateLike, /) -> bool: ...
    @overload
    def colliderect(self, rect: RectLike, /) -> bool: ...
    @overload
    def colliderect(self, left_top: CoordinateLike, width_height: CoordinateLike, /) -> bool: ...
    @overload
    def colliderect(
        self, left: float, top: float, width: float, height: float, /
    ) -> bool: ...
