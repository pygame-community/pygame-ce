from typing import Any, Callable, ClassVar, Optional, TypeAlias, TypeVar, Union, final
...
T = TypeVar("T", bound=Callable[[Event], Any])

def add_event_watcher(watcher: T, /) -> T: ...
def remove_event_watcher(watcher: T, /) -> None: ...
