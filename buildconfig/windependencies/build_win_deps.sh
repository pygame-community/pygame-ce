...
export CC="$WIN_ARCH-w64-mingw32-gcc"
export CXX="$WIN_ARCH-w64-mingw32-g++"
export AR="$WIN_ARCH-w64-mingw32-ar"
...
if [[ "$WIN_ARCH" == "i686" ]]; then
    export PG_BASE_MESON_FLAGS="$PG_BASE_MESON_FLAGS --cross-file $(pwd)/windows_i686.ini"
fi
