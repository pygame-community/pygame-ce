...
class TransformDisplayModuleTest(unittest.TestCase):
    ...
    def test_box_blur(self):
        data1 = {
            (1, 29): (226, 133, 111, 255),
            (47, 66): (198, 96, 90, 255),
            (84, 103): (192, 88, 88, 255),
            (131, 140): (191, 86, 89, 255),
            (158, 177): (193, 97, 100, 255),
            (195, 214): (151, 71, 98, 255),
            (232, 251): (158, 85, 106, 255),
            (269, 280): (208, 118, 120, 255),
            (306, 325): (194, 97, 106, 255),
            (353, 362): (161, 85, 97, 255),
            (380, 399): (172, 103, 108, 255),
            (417, 436): (188, 117, 108, 255),
            (458, 473): (169, 89, 92, 255),
            (491, 510): (142, 58, 79, 255),
        }
        data2 = {
            (1, 29): (91, 52, 43, 255),
            (47, 66): (192, 92, 87, 255),
            ...
            (380, 399): (172, 103, 108, 255),
            (417, 436): (188, 117, 108, 255),
            (458, 473): (150, 81, 82, 255),
            (491, 510): (51, 22, 29, 255),
        }

        data_fname = example_path("data")
        path = os.path.join(data_fname, "lena.png")
        sf = pygame.image.load(path).convert()

        sf_b1 = pygame.transform.box_blur(sf, 50)
        for pos in data1:
            # print(sf_b.get_at(pos))
    ...
    def test_gaussian_blur(self):
        data1 = {
            (10, 49): (224, 127, 105, 255),
            (47, 66): (205, 103, 93, 255),
            (84, 103): (181, 76, 83, 255),
            (121, 140): (192, 87, 88, 255),
            (148, 177): (201, 102, 99, 255),
            (195, 214): (141, 61, 94, 255),
            (232, 21): (205, 104, 102, 255),
            (269, 288): (211, 114, 118, 255),
            (306, 325): (206, 109, 114, 255),
            (343, 362): (141, 62, 85, 255),
            (384, 379): (170, 96, 101, 255),
            (417, 436): (192, 124, 112, 255),
            (454, 473): (174, 93, 92, 255),
            (491, 510): (139, 58, 80, 255),
        }
        data2 = {
            (10, 49): (148, 83, 68, 255),
            (47, 66): (204, 102, 92, 255),
            (84, 103): (181, 76, 83, 255),
            (121, 140): (192, 87, 88, 255),
            (148, 177): (201, 102, 99, 255),
            (195, 214): (141, 61, 94, 255),
            (232, 21): (168, 86, 84, 255),
            (269, 288): (211, 114, 118, 255),
            (306, 325): (206, 109, 114, 255),
            (343, 362): (141, 62, 85, 255),
            (384, 379): (170, 96, 101, 255),
            (417, 436): (192, 124, 112, 255),
            (454, 473): (167, 90, 89, 255),
            (491, 510): (57, 25, 34, 255),
        }
