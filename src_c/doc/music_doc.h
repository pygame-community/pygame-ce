...
#define DOC_MIXER_MUSIC_QUEUEE "Queue(filenames=[]) -> Queue\nobject to manage a music queue"
#define DOC_MIXER_MUSIC_QUEUEE_FILENAMES "filenames -> list[str]\nlist of musics in the queue"
#define DOC_MIXER_MUSIC_QUEUEE_INDEX "index -> int\nthe queue music index"
#define DOC_MIXER_MUSIC_QUEUEE_ADD "add(filename, loops=0) -> None\nadd a music to the queue"
#define DOC_MIXER_MUSIC_QUEUEE_REMOVE "remove(filename) -> None\nremove a music from the queue"
#define DOC_MIXER_MUSIC_QUEUEE_POP "pop(index) -> filename\npop a music index from the queue"
#define DOC_MIXER_MUSIC_QUEUEE_GETBUSY "get_busy() -> bool\ncheck if the queue will play the next music automatically"
#define DOC_MIXER_MUSIC_QUEUEE_GETCURRENT "get_current() -> int\nretrieve the index of the currently playing music"
#define DOC_MIXER_MUSIC_QUEUEE_GETNEXT "get_next() -> int\nretrieve the index of the music that will play next"
#define DOC_MIXER_MUSIC_QUEUEE_PLAY "play(loops=0, fade_ms=0, index=0) -> None\nstart the queue playback"
#define DOC_MIXER_MUSIC_QUEUEE_PLAYNEXT "play_next(loop=False) -> None\nstart playing the next music"
#define DOC_MIXER_MUSIC_QUEUEE_PLAYPREVIOUS "play_previous(loop=False) -> None\nstart playing the previous music"
#define DOC_MIXER_MUSIC_QUEUEE_PLAYAT "play_at(index) -> None\nstart playing the music at an index"
#define DOC_MIXER_MUSIC_QUEUEE_STOP "stop() -> None\nstop the queue from playing the next music automatically"
#define DOC_MIXER_MUSIC_QUEUEE_RESUME "resume() -> None\nallow the queue to play the next music automatically"
#define DOC_MIXER_MUSIC_QUEUEE_RESTART "restart() -> None\nreset the queue playback"
