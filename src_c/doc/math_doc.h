...
#define DOC_PYGAMEMATHLERP "lerp(a, b, weight, do_clamp) -> float\ninterpolates between two values by a weight."
#define DOC_PYGAMEMATHSMOOTHSTEP "lerp(a, b, weight) -> float\nsmoothly interpolates between two values by a weight."
