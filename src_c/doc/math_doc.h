...
#define DOC_MATH_VECTOR2_NORMALIZEORZERO "normalize_or_zero() -> Vector2\nreturns a normalized vector with the same direction, or a zero-vector if its length is zero.",
