...
#define DOC_RECT_UNIONALL "unionall(rects, /) -> Rect\nThe union of many rectangles."
#define DOC_RECT_UNIONALLIP "unionall_ip(rects, /) -> None\nThe union of many rectangles, in place."
...
#define DOC_RECT_COLLIDELIST "collidelist(rects, /) -> int\nTest if one rectangle in a list intersects."
#define DOC_RECT_COLLIDELISTALL "collidelistall(rects, /) -> list[int]\nTest if all rectangles in a list intersect."
...
#define DOC_RECT_COLLIDEDICT "collidedict(rect_dict, values=False) -> tuple[_RectLike_co, _V] | None\ncollidedict(rect_dict, values) -> tuple[_K, _RectLike_co] | None\nTest if one rectangle in a dictionary intersects."
#define DOC_RECT_COLLIDEDICTALL "collidedictall(rect_dict, values=False) -> list[tuple[_RectLike_co, _V]]\ncollidedictall(rect_dict, values) -> list[tuple[_K, _RectLike_co]]\nTest if all rectangles in a dictionary intersect."
