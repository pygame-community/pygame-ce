...
#define DOC_DISPLAY_SETMODE "set_mode(size=(0, 0), flags=0, depth=0, display=0, vsync=0) -> pygame.surface.Surface\nInitialize a window or screen for display."
#define DOC_DISPLAY_GETSURFACE "get_surface() -> Optional[pygame.surface.Surface]\nGet a reference to the currently set display surface."
