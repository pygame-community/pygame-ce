...
#define DOC_DISPLAY_DISPLAY_GETCLOSESTFULLSCREENMODE "get_closest_fullscreen_mode(width, height, refresh_rate, include_high_density_modes=True) -> DisplayMode | None\nReturns the closest fullscreen DisplayMode matching the parameters."
