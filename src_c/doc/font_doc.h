...
#define DOC_FONT_GETSDLTTFVERSION "get_sdl_ttf_version(linked=True) -> tuple[int, int, int]\nGets SDL_ttf version."
...
#define DOC_FONT_FONT_SETPOINTSIZE "set_point_size(val, /) -> None\nSet the point size of the font."
