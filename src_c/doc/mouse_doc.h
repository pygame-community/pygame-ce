...
#define DOC_MOUSE_GETDESKTOPPRESSED "get_desktop_pressed() -> (left_button, middle_button, right_button, x1_button, x2_button)\nget the desktop state of the mouse buttons"
