...
#define DOC_COMMIT "pygame.commit -> str\nThe short commit hash of the last commit in the git history when pygame-ce was built"
#define DOC_BRANCH "pygame.branch -> str\nThe branch name of the current branch on which pygame-ce was built"
#define DOC_CIBUILD "pygame.ci_build -> bool\nWhether pygame-ce was built on CI or not"
