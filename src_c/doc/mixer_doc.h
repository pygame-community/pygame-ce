...
#define DOC_MIXER_GETINIT "get_init() -> (frequency, format, channels) | None\ntest if the mixer is initialized"
...
#define DOC_MIXER_FINDCHANNEL "find_channel(force=False) -> Channel | None\nfind an unused channel"
...
#define DOC_MIXER_CHANNEL_GETSOUND "get_sound() -> Sound | None\nget the currently playing Sound"
#define DOC_MIXER_CHANNEL_QUEUE "queue(sound, /) -> None\nqueue a Sound object to follow the current"
#define DOC_MIXER_CHANNEL_GETQUEUE "get_queue() -> Sound | None\nreturn any Sound that is queued"
