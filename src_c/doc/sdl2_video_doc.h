...
#define DOC_SDL2_VIDEO_RENDERER_LOGICALTOWINDOW "logical_to_window(point) -> (int, int)\nTranslates logical coordinates to window coordinates"
...
#define DOC_SDL2_VIDEO_RENDERER_RENDERCOORDINATESTOWINDOW "logical_to_window(point) -> (int, int)\nAlias for logical_to_window"
#define DOC_SDL2_VIDEO_RENDERER_RENDERCOORDINATESFROMWINDOW "window_to_logical(point) -> (float, float)\nAlias for window_to_logical"
