...
#define DOC_SPRITE_GROUP_DRAW "draw(Surface, bgsurf=None, special_flags=0) -> list[Rect]\nblit the Sprite images"
...
#define DOC_SPRITE_RENDERUPDATES_DRAW "draw(surface, bgsurf=None, special_flags=0) -> Rect_list\nblit the Sprite images and track changed areas"
...
#define DOC_SPRITE_LAYEREDUPDATES_DRAW "draw(surface, bgsurf=None, special_flags=0) -> Rect_list\ndraw all sprites in the right order onto the passed surface."
