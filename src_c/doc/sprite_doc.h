...
#define DOC_SPRITE_SPRITECOLLIDE "spritecollide(sprite, group, dokill, collided = None, exclude = None) -> Sprite_list\nFind sprites in a group that intersect another sprite."
...
#define DOC_SPRITE_SPRITECOLLIDEANY "spritecollideany(sprite, group, collided = None, exclude = None) -> Sprite\nspritecollideany(sprite, group, collided = None, exclude = None) -> None\nSimple test if a sprite intersects anything in a group."
