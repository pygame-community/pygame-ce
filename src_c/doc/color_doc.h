...
#define DOC_COLOR_OKLAB "oklab -> tuple[float, float, float]\nGets or sets the Oklab representation of the Color."
#define DOC_COLOR_OKLCH "oklch -> tuple[float, float, float]\nGets or sets the Oklch representation of the Color."
...
#define DOC_COLOR_FROMOKLAB "from_oklab(object, /) -> Color\nfrom_oklab(l, a, b, /) -> Color\nReturns a Color object from a Oklab representation."
#define DOC_COLOR_FROMOKLCH "from_oklch(object, /) -> Color\nfrom_oklch(l, c, h, /) -> Color\nReturns a Color object from a Oklch representation."
