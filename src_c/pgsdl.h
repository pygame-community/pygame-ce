...
#define PGSDL_INIT_EVERYTHING \
    (PGSDL_INIT_AUDIO | PGSDL_INIT_VIDEO | PGSDL_INIT_JOYSTICK | \
     PGSDL_INIT_HAPTIC | PGSDL_INIT_GAMECONTROLLER | PGSDL_INIT_EVENTS)
#else
