...
typedef enum {
    PGE_DISPLAYORIENTATION = SDL_EVENT_DISPLAY_ORIENTATION,
    PGE_DISPLAYCONNECTED = SDL_EVENT_DISPLAY_ADDED,
    PGE_DISPLAYDISCONNECTED = SDL_EVENT_DISPLAY_REMOVED,
    PGE_DISPLAYMOVED = SDL_EVENT_DISPLAY_MOVED,
} PygameDisplayEventCode;
/*
 ...
 * these */
    ...
    PGE_DISPLAYORIENTATION,
    PGE_DISPLAYCONNECTED,
    PGE_DISPLAYDISCONNECTED,
    PGE_DISPLAYMOVED,
#endif
    ...
    PGPOST_DISPLAYORIENTATION,
    PGPOST_DISPLAYCONNECTED,
    PGPOST_DISPLAYDISCONNECTED,
    PGPOST_DISPLAYMOVED,
#if SDL_VERSION_ATLEAST(3, 0, 0)
    PGPOST_DISPLAY_DESKTOP_MODE_CHANGED,
    PGPOST_DISPLAY_CURRENT_MODE_CHANGED,
    PGPOST_DISPLAY_CONTENT_SCALE_CHANGED,
    PGPOST_DISPLAY_USABLE_BOUNDS_CHANGED,
#endif
