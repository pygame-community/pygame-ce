...
#define PYGAME_USEREVENT_DROPFILE 0x1000
    ...
    DEC_CONST(PROGRESS_STATE_NONE);
    DEC_CONST(PROGRESS_STATE_INDETERMINATE);
    DEC_CONST(PROGRESS_STATE_NORMAL);
    DEC_CONST(PROGRESS_STATE_PAUSED);
    DEC_CONST(PROGRESS_STATE_ERROR);
#else
    DEC_CONSTS(SYSTEM_THEME_DARK, -1);
    DEC_CONSTS(SYSTEM_THEME_LIGHT, -1);
    DEC_CONSTS(SYSTEM_THEME_UNKNOWN, -1);

    DEC_CONSTS(PROGRESS_STATE_NONE, -1);
    DEC_CONSTS(PROGRESS_STATE_INDETERMINATE, -1);
    DEC_CONSTS(PROGRESS_STATE_NORMAL, -1);
    DEC_CONSTS(PROGRESS_STATE_PAUSED, -1);
    DEC_CONSTS(PROGRESS_STATE_ERROR, -1);
#endif
