...
#define DEC_CONST_EVENT(x) DEC_CONSTS_(#x, SDL_EVENT_##x)
...
#define PYGAME_BLEND_ALPHA_SDL2 0x12
    ...
    DEC_CONSTS(DISPLAYORIENTATIONCHANGED, SDL_EVENT_DISPLAY_ORIENTATION);
    DEC_CONSTS(DISPLAYADDED, SDL_EVENT_DISPLAY_ADDED);
    DEC_CONSTS(DISPLAYREMOVED, SDL_EVENT_DISPLAY_REMOVED);
    DEC_CONSTS(DISPLAYMOVED, SDL_EVENT_DISPLAY_MOVED);
    DEC_CONSTS(DISPLAYDESKTOPMODECHANGED,
               SDL_EVENT_DISPLAY_DESKTOP_MODE_CHANGED);
    DEC_CONSTS(DISPLAYCURRENTMODECHANGED,
               SDL_EVENT_DISPLAY_CURRENT_MODE_CHANGED);
    DEC_CONSTS(DISPLAYCONTENTSCALECHANGED,
               SDL_EVENT_DISPLAY_CONTENT_SCALE_CHANGED);
    DEC_CONSTS(DISPLAYUSABLEBOUNDSCHANGED,
               SDL_EVENT_DISPLAY_USABLE_BOUNDS_CHANGED);
#else
    DEC_CONSTS(DISPLAYORIENTATIONCHANGED, 0);
    DEC_CONSTS(DISPLAYADDED, 0);
    DEC_CONSTS(DISPLAYREMOVED, 0);
    DEC_CONSTS(DISPLAYMOVED, 0);
    DEC_CONSTS(DISPLAYDESKTOPMODECHANGED, 0);
    DEC_CONSTS(DISPLAYCURRENTMODECHANGED, 0);
    DEC_CONSTS(DISPLAYCONTENTSCALECHANGED, 0);
    DEC_CONSTS(DISPLAYUSABLEBOUNDSCHANGED, 0);
#endif
...
#if SDL_VERSION_ATLEAST(3, 0, 0)
    DEC_CONST(SYSTEM_THEME_DARK);
    DEC_CONST(SYSTEM_THEME_LIGHT);
    DEC_CONST(SYSTEM_THEME_UNKNOWN);
#else
    DEC_CONSTS(SYSTEM_THEME_DARK, -1);
    DEC_CONSTS(SYSTEM_THEME_LIGHT, -1);
    DEC_CONSTS(SYSTEM_THEME_UNKNOWN, -1);
#endif
