...
#define PYGAME_BLEND_ALPHA_SDL2 0x12
    ...
    DEC_CONSTS(DISPLAYORIENTATIONCHANGED, PGE_DISPLAYORIENTATION);
    DEC_CONSTS(DISPLAYADDED, PGE_DISPLAYCONNECTED);
    DEC_CONSTS(DISPLAYREMOVED, PGE_DISPLAYDISCONNECTED);
    DEC_CONSTS(DISPLAYMOVED, PGE_DISPLAYMOVED);
    DEC_CONST_EVENT(DISPLAY_DESKTOP_MODE_CHANGED);
    DEC_CONST_EVENT(DISPLAY_CURRENT_MODE_CHANGED);
    DEC_CONST_EVENT(DISPLAY_CONTENT_SCALE_CHANGED);
    DEC_CONST_EVENT(DISPLAY_USABLE_BOUNDS_CHANGED);
#else
    DEC_CONSTS(DISPLAYORIENTATIONCHANGED, 0);
    DEC_CONSTS(DISPLAYADDED, 0);
    DEC_CONSTS(DISPLAYREMOVED, 0);
    DEC_CONSTS(DISPLAYMOVED, 0);
    DEC_CONSTS(DISPLAY_DESKTOP_MODE_CHANGED, 0);
    DEC_CONSTS(DISPLAY_CURRENT_MODE_CHANGED, 0);
    DEC_CONSTS(DISPLAY_CONTENT_SCALE_CHANGED, 0);
    DEC_CONSTS(DISPLAY_USABLE_BOUNDS_CHANGED, 0);
#endif
