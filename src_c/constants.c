...
#define PYGAME_BLEND_ALPHA_SDL2 0x12
    ...
    DEC_CONSTS(DISPLAY_ORIENTATION_CHANGED, SDL_EVENT_DISPLAY_ORIENTATION);
    DEC_CONST_EVENT(DISPLAY_ADDED);
    DEC_CONST_EVENT(DISPLAY_REMOVED);
    DEC_CONST_EVENT(DISPLAY_MOVED);
...
#else
    DEC_CONSTS(DISPLAY_ORIENTATION_CHANGED, 0);
    DEC_CONSTS(DISPLAY_ADDED, 0);
    DEC_CONSTS(DISPLAY_REMOVED, 0);
    DEC_CONSTS(DISPLAY_MOVED, 0);
