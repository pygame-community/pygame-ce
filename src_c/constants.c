...
#define PYGAME_BLEND_ALPHA_SDL2 0x12
    ...
    DEC_CONSTN(PG_AUDIO_ALLOW_FREQUENCY_CHANGE);
    DEC_CONSTN(PG_AUDIO_ALLOW_FORMAT_CHANGE);
    DEC_CONSTN(PG_AUDIO_ALLOW_CHANNELS_CHANGE);
    DEC_CONSTN(PG_AUDIO_ALLOW_ANY_CHANGE);
    DEC_CONST(DROPFILE);
    DEC_CONST(DROPTEXT);
    DEC_CONST(DROPBEGIN);
