...
_scrap_init(PyObject *self, PyObject *args)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.init deprecated since 2.1.3", 1) == -1) {
        return NULL;
    }
...
{
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.get_init deprecated since 2.1.3",
                     1) == -1) {
        return NULL;
    }
...
_scrap_get_types(PyObject *self, PyObject *_null)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.get_types deprecated since 2.1.3",
                     1) == -1) {
        return NULL;
    }
...
_scrap_contains(PyObject *self, PyObject *args)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.contains deprecated since 2.1.3",
                     1) == -1) {
        return NULL;
    }
...
_scrap_get_scrap(PyObject *self, PyObject *args)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.get deprecated since 2.1.3. Consider using"
...
_scrap_put_scrap(PyObject *self, PyObject *args)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.put deprecated since 2.1.3. Consider using"
...
_scrap_set_mode(PyObject *self, PyObject *args)
{
    ...
    if (PyErr_WarnEx(PyExc_DeprecationWarning,
                     "pygame.scrap.set_mode deprecated since 2.1.3",
                     1) == -1) {
        return NULL;
    }
