...
**English** `简体中文`_ `繁體中文`_ `Français`_ `فارسی`_ `Español`_ `日本語`_ `Italiano`_ `Русский`_ `Ελληνικά_`
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
έτσι κάνοντας τη γραφή αυτών των προγραμμάτων μια πιο διαισθητική εργασία.

Αυτή η διανομή ονομάζεται **'pygame - Έκδοση Κοινότητας'** ('pygame-ce' για συντομία).
